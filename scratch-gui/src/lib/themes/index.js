...
import * as accentSquiggle from './accent/squiggle';
...
import * as guiSquiggle from './gui/squiggle';
...
import * as blocksSquiggle from './blocks/squiggle';

const ACCENT_SQUIGGLE = 'squiggle';
const ACCENT_PURPLE = 'purple';
const ACCENT_BLUE = 'blue';
const ACCENT_RED = 'red';
const ACCENT_RAINBOW = 'rainbow';
const ACCENT_MAP = {
    [ACCENT_SQUIGGLE]: accentSquiggle,
    [ACCENT_PURPLE]: accentPurple,
    [ACCENT_BLUE]: accentBlue,
    [ACCENT_RED]: accentRed,
    [ACCENT_RAINBOW]: accentRainbow
};
const ACCENT_DEFAULT = ACCENT_SQUIGGLE;

const GUI_LIGHT = 'light';
const GUI_DARK = 'dark';
const GUI_SQUIGGLE = 'squiggle';
const GUI_MAP = {
    [GUI_LIGHT]: guiLight,
    [GUI_DARK]: guiDark,
    [GUI_SQUIGGLE]: guiSquiggle
};
const GUI_DEFAULT = GUI_SQUIGGLE;

const BLOCKS_THREE = 'three';
const BLOCKS_DARK = 'dark';
const BLOCKS_SQUIGGLE = 'squiggle';
...
const BLOCKS_MAP = {
    ...
    [BLOCKS_SQUIGGLE]: {
        blocksMediaFolder: 'blocks-media/default',
        colors: defaultsDeep({}, blocksSquiggle.blockColors, defaultBlockColors),
        extensions: blocksSquiggle.extensions,
        customExtensionColors: blocksSquiggle.customExtensionColors,
        useForStage: false
    },
    [BLOCKS_CUSTOM]: {
...
class Theme {
    ...
    static squiggle = new Theme(ACCENT_SQUIGGLE, GUI_SQUIGGLE, BLOCKS_DEFAULT);
    ...
    // High contrast is a legibility choice, so it stays on the light chrome
    // rather than inheriting the (dark) default gui.
    static highContrast = new Theme(ACCENT_DEFAULT, GUI_LIGHT, BLOCKS_HIGH_CONTRAST);
